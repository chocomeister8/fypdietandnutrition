...
public class BeforeBookConsultationAdapter extends BaseAdapter {
    ...
    public BeforeBookConsultationAdapter(Context context, ArrayList<Consultation> consultationList) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.consultation_item_bf_book, parent, false);
